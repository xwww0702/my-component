...
describe("Notification", () => {
  ...
  test("notification offset", async () => {
    notification({ message: "hello msg1", duration: 0, offset: 100 });
    notification({ message: "hello msg2", duration: 0, offset: 50 });
    await rAF();
    const element = document.querySelectorAll(".er-notification");
